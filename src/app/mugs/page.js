        ...
        <div className="container p-8 mx-auto">
          <div className="flex flex-wrap m-0 justify-center align-middle">
            <div className="text-center w-full my-4">
              <span className='text-pink-500 font-bold text-xl'>Mugs</span>
            </div>
            ...
            <span className='text-gray-500 font-bold text-lg'>Currently Mugs are Out of Stock</span>
        </div>
            }
          </div>
        </div>
